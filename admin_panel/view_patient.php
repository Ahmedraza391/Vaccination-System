...
<?php include("top.php"); ?>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <?php
                $id = $_GET['id'];
                $insert_query = "SELECT tbl_patient.*,tbl_city.city FROM tbl_patient INNER JOIN tbl_city ON tbl_patient.cid = tbl_city.id WHERE tbl_patient.id = $id";
                $check_result = mysqli_fetch_assoc(mysqli_query($connection,$insert_query));
            ?>
            <div class="container position-relative ">
                <div class="row m-0 mt-3">
                    <div class="col-sm-12 col-md-2">
                        <a href="patients.php" class="btn btn-green d-small-none position-absolute mt-1 me-1 ms-md-3"><i class="fas fa-long-arrow-alt-left"></i></a>
                    </div>
                ...
                <div class="row m-0 bg-green  p-5">
