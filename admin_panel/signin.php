            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-8">
                    <div class="bg-green rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <?php
                            if(isset($_POST['signin'])){
                                ...
                                if($result){
                                    ...
                                    $_SESSION['sign_in'] = $check_result;
                                    $_SESSION['sign_in_id'] = $check_result['id'];
                        ...
                        ?>
                        <p class="text-center mb-0">Don't have an Account? <a href="signup.php" class="text-white text-decoration-underline ">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
